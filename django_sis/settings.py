...
CONSTANCE_CONFIG = {
    ...
    'EDIT_ALL_STUDENT_WORKER_FIELDS': ('False', ''),
    'COUNSELING_REFERRAL_NOTICE_EMAIL_TO': ('', ''),
    'ADMISSIONS_TO_STUDENT_ALSO_MAKES_STUDENT_WORKER': ('False', ''),
    ...
    'WORK_STUDY_MESSAGE_TO_STUDENT_MISSING_TIME_SHEET': ('You did not submit a timesheet today.', ''),
...
Use 'demonstrations' to see counts of demonstrations for students and assignments."),
    ...
    'SCHOOL_PAY_RATE_PER_HOUR': ('13.00', ''),
    'STUDENT_PAY_RATE_PER_HOUR': ('9.00', ''),
    
    'FROM_EMAIL_ADDRESS': ('donotreply@cristoreyny.org', ''),
    'ADMISSIONS_NOTIFY_EMAIL': ('', 'Send admissions notifications to this email. Comma separated are ok.'),   
    'WORK_STUDY_SHOW_COMMENT_DEFAULT': ('True', ''),
    'WORK_STUDY_TIMESHEET_INITIAL_TIME': ('True', ''),
    'WORK_STUDY_CONTRACT_FROM_ADDRESS': ('donotreply@cristoreyny.org', ''),

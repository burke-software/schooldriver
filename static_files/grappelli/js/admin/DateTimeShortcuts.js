...
var DateTimeShortcuts = {
    ...
    admin_media_prefix: '/admin/grappelli',
    init: function() {
        ...
        if (window.__admin_media_prefix__ != undefined) {
            ...
            DateTimeShortcuts.admin_media_prefix = '/static/grappelli/';
        }
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', '/static/grappelli/img/admin/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));

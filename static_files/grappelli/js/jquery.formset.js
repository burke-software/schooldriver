...
;(function($) {
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label').each(function() {
                    ...
                    if (elem.is('input:checkbox') || elem.is('input:radio')) {
                        ...
                        if (!(elem.attr('name') && options.initialFields.indexOf(elem.attr('name').replace(new RegExp(options.prefix + '-\\d+-'), ''))!=-1)) {
                            elem.val('');
                        }
                    }
                });
    ...
    $.fn.formset.defaults = {
        ...
        initialFields: []                // Fields that contains initial values that should be copied to new form instances
    };
})(jQuery)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'omr', ['Test'])

        # Adding M2M table for field teachers on 'Test'
        db.create_table(u'omr_test_teachers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('test', models.ForeignKey(orm[u'omr.test'], null=False)),
            ('faculty', models.ForeignKey(orm[u'sis.faculty'], null=False))
        ))
        db.create_unique(u'omr_test_teachers', ['test_id', 'faculty_id'])

        # Adding M2M table for field courses on 'Test'
        db.create_table(u'omr_test_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('test', models.ForeignKey(orm[u'omr.test'], null=False)),
            ('course', models.ForeignKey(orm[u'schedule.course'], null=False))
        ))
        db.create_unique(u'omr_test_courses', ['test_id', 'course_id'])

        # Adding model 'QuestionBank'
        db.create_table(u'omr_questionbank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('ckeditor.fields.RichTextField')()),
            ('theme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'omr', ['QuestionBank'])

        # Adding M2M table for field benchmarks on 'QuestionBank'
        db.create_table(u'omr_questionbank_benchmarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionbank', models.ForeignKey(orm[u'omr.questionbank'], null=False)),
            ('benchmark', models.ForeignKey(orm[u'benchmarks.benchmark'], null=False))
        ))
        db.create_unique(u'omr_questionbank_benchmarks', ['questionbank_id', 'benchmark_id'])

        # Adding model 'NetworkQuestionBank'
        db.create_table(u'omr_networkquestionbank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('ckeditor.fields.RichTextField')()),
            ('theme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='Multiple Choice', max_length=25)),
        ...
        db.send_create_signal(u'omr', ['NetworkQuestionBank'])

        # Adding M2M table for field benchmarks on 'NetworkQuestionBank'
        db.create_table(u'omr_networkquestionbank_benchmarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('networkquestionbank', models.ForeignKey(orm[u'omr.networkquestionbank'], null=False)),
            ('benchmark', models.ForeignKey(orm[u'benchmarks.benchmark'], null=False))
        ))
        db.create_unique(u'omr_networkquestionbank_benchmarks', ['networkquestionbank_id', 'benchmark_id'])

        # Adding model 'Question'
        db.create_table(u'omr_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('ckeditor.fields.RichTextField')()),
            ('theme', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='Multiple Choice', max_length=25)),
        ...
        db.send_create_signal(u'omr', ['Question'])

        # Adding M2M table for field benchmarks on 'Question'
        db.create_table(u'omr_question_benchmarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'omr.question'], null=False)),
            ('benchmark', models.ForeignKey(orm[u'benchmarks.benchmark'], null=False))
        ))
        db.create_unique(u'omr_question_benchmarks', ['question_id', 'benchmark_id'])

        # Adding model 'AnswerBank'
        db.create_table(u'omr_answerbank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('ckeditor.fields.RichTextField')()),
            ('error_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal(u'omr', ['AnswerBank'])

        # Adding model 'Answer'
        db.create_table(u'omr_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('ckeditor.fields.RichTextField')()),
            ('error_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('point_value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'omr', ['Answer'])

        # Adding model 'TestInstance'
        db.create_table(u'omr_testinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('results_received', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'omr', ['TestInstance'])

        # Adding M2M table for field teachers on 'TestInstance'
        db.create_table(u'omr_testinstance_teachers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('testinstance', models.ForeignKey(orm[u'omr.testinstance'], null=False)),
            ('faculty', models.ForeignKey(orm[u'sis.faculty'], null=False))
        ))
        db.create_unique(u'omr_testinstance_teachers', ['testinstance_id', 'faculty_id'])

        # Adding model 'AnswerInstance'
        db.create_table(u'omr_answerinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'omr', ['AnswerInstance'])

        # Adding unique constraint on 'AnswerInstance', fields ['test_instance', 'question']
        db.create_unique(u'omr_answerinstance', ['test_instance_id', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AnswerInstance', fields ['test_instance', 'question']
        db.delete_unique(u'omr_answerinstance', ['test_instance_id', 'question_id'])

        # Deleting model 'Test'
        db.delete_table(u'omr_test')
        ...
        db.delete_table(u'omr_questionbank')
        ...
        db.delete_table(u'omr_answerinstance')

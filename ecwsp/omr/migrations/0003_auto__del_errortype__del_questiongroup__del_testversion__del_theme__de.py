...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'omr_errortype')

        # Deleting model 'QuestionGroup'
        db.delete_table(u'omr_questiongroup')

        # Deleting model 'TestVersion'
        db.delete_table(u'omr_testversion')

        # Deleting model 'Theme'
        db.delete_table(u'omr_theme')

        # Deleting field 'Question.group'
        db.delete_column(u'omr_question', 'group_id')

        # Adding field 'Question.theme'
        db.add_column(u'omr_question', 'theme',
        ...
        # Renaming column for 'Answer.error_type' to match new field type.
        ...
        # Adding field 'NetworkQuestionBank.theme'
        db.add_column(u'omr_networkquestionbank', 'theme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'QuestionBank.group'
        db.delete_column(u'omr_questionbank', 'group_id')

        # Adding field 'QuestionBank.theme'
        db.add_column(u'omr_questionbank', 'theme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding index on 'AnswerBank', fields ['error_type']
        db.create_index(u'omr_answerbank', ['error_type_id'])

        # Adding index on 'Answer', fields ['error_type']
        db.create_index(u'omr_answer', ['error_type_id'])

        # Adding model 'ErrorType'
        db.create_table(u'omr_errortype', (
        ...
        db.create_table(u'omr_questiongroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ))
        ...
        db.create_table(u'omr_testversion', (
        ...
        # Adding model 'Theme'
        db.create_table(u'omr_theme', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ))
        db.send_create_signal('omr', ['Theme'])

        # Adding field 'Question.group'
        db.add_column(u'omr_question', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.QuestionGroup'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Question.theme'
        db.delete_column(u'omr_question', 'theme')

        # Adding M2M table for field themes on 'Question'
        db.create_table(u'omr_question_themes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['omr.question'], null=False)),
            ('theme', models.ForeignKey(orm['omr.theme'], null=False))
        ))
        db.create_unique(u'omr_question_themes', ['question_id', 'theme_id'])


        # Renaming column for 'Answer.error_type' to match new field type.
        db.rename_column(u'omr_answer', 'error_type', 'error_type_id')
        # Changing field 'Answer.error_type'
        db.alter_column(u'omr_answer', 'error_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.ErrorType'], null=True))

        # Renaming column for 'AnswerBank.error_type' to match new field type.
        db.rename_column(u'omr_answerbank', 'error_type', 'error_type_id')
        # Changing field 'AnswerBank.error_type'
        db.alter_column(u'omr_answerbank', 'error_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.ErrorType'], null=True))
        # Adding field 'NetworkQuestionBank.group'
        db.add_column(u'omr_networkquestionbank', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.QuestionGroup'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NetworkQuestionBank.theme'
        db.delete_column(u'omr_networkquestionbank', 'theme')

        # Adding M2M table for field themes on 'NetworkQuestionBank'
        db.create_table(u'omr_networkquestionbank_themes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('networkquestionbank', models.ForeignKey(orm['omr.networkquestionbank'], null=False)),
            ('theme', models.ForeignKey(orm['omr.theme'], null=False))
        ))
        db.create_unique(u'omr_networkquestionbank_themes', ['networkquestionbank_id', 'theme_id'])

        # Adding field 'QuestionBank.group'
        db.add_column(u'omr_questionbank', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.QuestionGroup'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'QuestionBank.theme'
        db.delete_column(u'omr_questionbank', 'theme')

        # Adding M2M table for field themes on 'QuestionBank'
        db.create_table(u'omr_questionbank_themes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionbank', models.ForeignKey(orm['omr.questionbank'], null=False)),
            ('theme', models.ForeignKey(orm['omr.theme'], null=False))
        ))
        db.create_unique(u'omr_questionbank_themes', ['questionbank_id', 'theme_id'])

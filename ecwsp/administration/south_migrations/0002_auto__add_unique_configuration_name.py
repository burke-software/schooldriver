...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Configuration', fields ['name']
        db.create_unique(u'administration_configuration', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Configuration', fields ['name']
        db.delete_unique(u'administration_configuration', ['name'])

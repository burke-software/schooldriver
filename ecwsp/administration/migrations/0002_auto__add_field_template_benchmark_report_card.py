...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.benchmark_report_card'
        db.add_column(u'administration_template', 'benchmark_report_card',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.benchmark_report_card'
        db.delete_column(u'administration_template', 'benchmark_report_card')

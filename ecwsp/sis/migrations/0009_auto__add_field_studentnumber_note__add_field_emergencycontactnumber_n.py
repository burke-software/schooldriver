...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentNumber.note'
        db.add_column('sis_studentnumber', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EmergencyContactNumber.note'
        db.add_column('sis_emergencycontactnumber', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentNumber.note'
        db.delete_column('sis_studentnumber', 'note')

        # Deleting field 'EmergencyContactNumber.note'
        db.delete_column('sis_emergencycontactnumber', 'note')

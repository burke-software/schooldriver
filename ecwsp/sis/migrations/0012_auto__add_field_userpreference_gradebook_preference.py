...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPreference.gradebook_preference'
        db.add_column(u'sis_userpreference', 'gradebook_preference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPreference.gradebook_preference'
        db.delete_column(u'sis_userpreference', 'gradebook_preference')

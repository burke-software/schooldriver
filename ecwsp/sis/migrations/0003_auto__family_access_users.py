...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sis_student_family_access_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm['sis.student'], null=False)),
            # jnm 20120730 hack per http://south.aeracode.org/ticket/1070
            # changed orm['sis.familyaccessuser'] to orm['auth.user']
            ('familyaccessuser', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('sis_student_family_access_users', ['student_id', 'familyaccessuser_id'])

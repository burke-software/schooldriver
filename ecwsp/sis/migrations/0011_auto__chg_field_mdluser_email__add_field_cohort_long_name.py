...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sis_mdluser', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))
        # Adding field 'Cohort.long_name'
        db.add_column(u'sis_cohort', 'long_name',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MdlUser.email'
        db.alter_column(u'sis_mdluser', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        # Deleting field 'Cohort.long_name'
        db.delete_column(u'sis_cohort', 'long_name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Faculty.id'
        db.add_column(u'sis_faculty', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='LOL', primary_key=True),
                      keep_default=False)

        # Adding field 'Faculty.user'
        db.add_column(u'sis_faculty', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='LOL', to=orm['auth.User'], unique=True),
                      keep_default=False)

        # Deleting field 'Student.mdluser_ptr'
        db.delete_column(u'sis_student', u'mdluser_ptr_id')

        # Adding field 'Student.id'
        db.add_column(u'sis_student', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='LOL', primary_key=True),
                      keep_default=False)

        # Adding field 'Student.user'
        db.add_column(u'sis_student', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='LOL', to=orm['auth.User'], unique=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Faculty.mdluser_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Faculty.mdluser_ptr' and its values cannot be restored.")
        # Adding field 'Faculty.alt_email'
        db.add_column(u'sis_faculty', 'alt_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Deleting field 'Faculty.id'
        db.delete_column(u'sis_faculty', u'id')

        # Deleting field 'Faculty.user'
        db.delete_column(u'sis_faculty', 'user_id')

        # Adding field 'Student.mdluser_ptr'
        db.add_column(u'sis_student', u'mdluser_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='LOL', to=orm['sis.MdlUser'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Student.id'
        db.delete_column(u'sis_student', u'id')

        # Deleting field 'Student.user'
        db.delete_column(u'sis_student', 'user_id')
    ...
    models = {
        ...
        u'sis.faculty': {
            'Meta': {'ordering': "('user__last_name', 'user__first_name')", 'object_name': 'Faculty'},
            'ext': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

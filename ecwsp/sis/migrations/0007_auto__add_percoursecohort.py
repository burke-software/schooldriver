...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sis_percoursecohort', (
            ('cohort_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sis.Cohort'], unique=True, primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Course'])),
        ))
        db.send_create_signal('sis', ['PerCourseCohort'])


    def backwards(self, orm):
        # Deleting model 'PerCourseCohort'
        db.delete_table('sis_percoursecohort')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmergencyContact.sync_schoolreach'
        db.add_column('sis_emergencycontact', 'sync_schoolreach',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EmergencyContactNumber.primary'
        db.add_column('sis_emergencycontactnumber', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmergencyContact.sync_schoolreach'
        db.delete_column('sis_emergencycontact', 'sync_schoolreach')

        # Deleting field 'EmergencyContactNumber.primary'
        db.delete_column('sis_emergencycontactnumber', 'primary')
    ...
    models = {
        ...
        'sis.percoursecohort': {
            'Meta': {'object_name': 'PerCourseCohort', '_ormbases': ['sis.Cohort']},
            'cohort_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['sis.Cohort']", 'unique': 'True', 'primary_key': 'True'}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Course']"})
        },
        'sis.reasonleft': {

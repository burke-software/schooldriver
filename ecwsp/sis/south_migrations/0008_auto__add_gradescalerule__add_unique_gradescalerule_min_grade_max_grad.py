...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sis_gradescalerule', (
            ...
            ('grade_scale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sis.GradeScale'])),
        ))
        db.send_create_signal(u'sis', ['GradeScaleRule'])

        # Adding unique constraint on 'GradeScaleRule', fields ['min_grade', 'max_grade', 'grade_scale']
        db.create_unique(u'sis_gradescalerule', ['min_grade', 'max_grade', 'grade_scale_id'])

        # Adding model 'GradeScale'
        db.create_table(u'sis_gradescale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'sis', ['GradeScale'])


        # Changing field 'SchoolYear.grade_scale'
        db.alter_column(u'sis_schoolyear', 'grade_scale_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sis.GradeScale'], null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'GradeScaleRule', fields ['min_grade', 'max_grade', 'grade_scale']
        db.delete_unique(u'sis_gradescalerule', ['min_grade', 'max_grade', 'grade_scale_id'])

        # Deleting model 'GradeScaleRule'
        db.delete_table(u'sis_gradescalerule')

        # Deleting model 'GradeScale'
        db.delete_table(u'sis_gradescale')


        # Changing field 'SchoolYear.grade_scale'
        db.alter_column(u'sis_schoolyear', 'grade_scale_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grades.GradeScale'], null=True))

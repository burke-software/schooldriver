...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'PerCourseCohort.course'
        db.rename_column(u'sis_percoursecohort', 'course_id', 'course_section_id')


    def backwards(self, orm):
        # Renaming field 'PerCourseCohort.course_section'
        db.rename_column(u'sis_percoursecohort', 'course_section_id', 'course_id')

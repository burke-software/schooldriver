...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolYear.grade_scale'
        db.add_column(u'sis_schoolyear', 'grade_scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grades.GradeScale'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SchoolYear.grade_scale'
        db.delete_column(u'sis_schoolyear', 'grade_scale_id')

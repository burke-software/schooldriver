...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPreference.omr_default_point_value'
        db.delete_column(u'sis_userpreference', 'omr_default_point_value')

        # Deleting field 'UserPreference.omr_default_number_answers'
        db.delete_column(u'sis_userpreference', 'omr_default_number_answers')

        # Deleting field 'UserPreference.omr_default_save_question_to_bank'
        db.delete_column(u'sis_userpreference', 'omr_default_save_question_to_bank')


    def backwards(self, orm):
        # Adding field 'UserPreference.omr_default_point_value'
        db.add_column(u'sis_userpreference', 'omr_default_point_value',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'UserPreference.omr_default_number_answers'
        db.add_column(u'sis_userpreference', 'omr_default_number_answers',
                      self.gf('django.db.models.fields.IntegerField')(default=2, blank=True),
                      keep_default=False)

        # Adding field 'UserPreference.omr_default_save_question_to_bank'
        db.add_column(u'sis_userpreference', 'omr_default_save_question_to_bank',

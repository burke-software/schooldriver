...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.application_decision_by'
        db.alter_column(u'admissions_applicant', 'application_decision_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sis.Faculty'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Applicant.application_decision_by'
        db.alter_column(u'admissions_applicant', 'application_decision_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'admissions.applicant': {
            ...
            'family_preferred_language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sis.LanguageChoice']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'school_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sis.SchoolYear']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'admissions.applicantstandardtestresult': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admissions.Applicant']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

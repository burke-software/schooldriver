...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplicantCustomField.required'
        db.add_column(u'admissions_applicantcustomfield', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplicantCustomField.required'
        db.delete_column(u'admissions_applicantcustomfield', 'required')
    ...
    models = {
        ...
        u'admissions.applicantstandardtestresult': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admissions.Applicant']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

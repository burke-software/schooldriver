...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentApplicationTemplate'
        db.create_table(u'admissions_studentapplicationtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('json_template', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'admissions', ['StudentApplicationTemplate'])


        # Changing field 'Applicant.parent_email'
        db.alter_column(u'admissions_applicant', 'parent_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'Applicant.email'
        db.alter_column(u'admissions_applicant', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

    def backwards(self, orm):
        # Deleting model 'StudentApplicationTemplate'
        db.delete_table(u'admissions_studentapplicationtemplate')


        # Changing field 'Applicant.parent_email'
        db.alter_column(u'admissions_applicant', 'parent_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Applicant.email'
        db.alter_column(u'admissions_applicant', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        u'admissions.applicant': {
            ...
            'country_of_birth': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': u"orm['admissions.CountryOption']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'admissions.applicantstandardtestresult': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admissions.Applicant']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicantAdditionalInformation'
        db.create_table(u'admissions_applicantadditionalinformation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='additionals', to=orm['admissions.Applicant'])),
            ('custom_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admissions.ApplicantCustomField'], null=True)),
            ('answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'admissions', ['ApplicantAdditionalInformation'])

        # Adding model 'ApplicantCustomField'
        db.create_table(u'admissions_applicantcustomfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('is_field_integrated_with_applicant', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('field_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('field_label', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('field_choices', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('helptext', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
        ))
        db.send_create_signal(u'admissions', ['ApplicantCustomField'])


    def backwards(self, orm):
        # Deleting model 'ApplicantAdditionalInformation'
        db.delete_table(u'admissions_applicantadditionalinformation')

        # Deleting model 'ApplicantCustomField'
        db.delete_table(u'admissions_applicantcustomfield')
    ...
    models = {
        ...
        u'admissions.applicant': {
            ...
            'application_decision_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sis.Faculty']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'country_of_birth': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['admissions.CountryOption']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'admissions.applicantadditionalinformation': {
            'Meta': {'object_name': 'ApplicantAdditionalInformation'},
            'answer': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'additionals'", 'to': u"orm['admissions.Applicant']"}),
            'custom_field': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admissions.ApplicantCustomField']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'admissions.applicantcustomfield': {
            'Meta': {'object_name': 'ApplicantCustomField'},
            'field_choices': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'field_label': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'field_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'field_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'helptext': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_field_integrated_with_applicant': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'admissions.applicantstandardtestresult': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admissions.Applicant']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'admissions.studentapplicationtemplate': {
            'Meta': {'object_name': 'StudentApplicationTemplate'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

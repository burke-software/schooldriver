...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admissions_schooltype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('admissions', ['SchoolType'])

        # Adding field 'FeederSchool.school_type'
        db.add_column('admissions_feederschool', 'school_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admissions.SchoolType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SchoolType'
        db.delete_table('admissions_schooltype')

        # Deleting field 'FeederSchool.school_type'
        db.delete_column('admissions_feederschool', 'school_type_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admissions_placeofworship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('admissions', ['PlaceOfWorship'])

        # Adding field 'Applicant.place_of_worship'
        db.add_column('admissions_applicant', 'place_of_worship',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admissions.PlaceOfWorship'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('admissions_placeofworship')

        # Deleting field 'Applicant.place_of_worship'
        db.delete_column('admissions_applicant', 'place_of_worship_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.family_preferred_language'
        db.add_column('admissions_applicant', 'family_preferred_language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sis.LanguageChoice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.family_preferred_language'
        db.delete_column('admissions_applicant', 'family_preferred_language_id')

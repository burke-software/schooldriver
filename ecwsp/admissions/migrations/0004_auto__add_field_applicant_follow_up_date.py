...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.follow_up_date'
        db.add_column('admissions_applicant', 'follow_up_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.follow_up_date'
        db.delete_column('admissions_applicant', 'follow_up_date')

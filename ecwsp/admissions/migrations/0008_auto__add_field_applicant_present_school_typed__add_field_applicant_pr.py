...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.present_school_typed'
        db.add_column('admissions_applicant', 'present_school_typed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Applicant.present_school_type_typed'
        db.add_column('admissions_applicant', 'present_school_type_typed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Applicant.from_online_inquiry'
        db.add_column('admissions_applicant', 'from_online_inquiry',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.present_school_typed'
        db.delete_column('admissions_applicant', 'present_school_typed')

        # Deleting field 'Applicant.present_school_type_typed'
        db.delete_column('admissions_applicant', 'present_school_type_typed')

        # Deleting field 'Applicant.from_online_inquiry'
        db.delete_column('admissions_applicant', 'from_online_inquiry')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FeederSchool', fields ['name']
        db.create_unique(u'admissions_feederschool', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'FeederSchool', fields ['name']
        db.delete_unique(u'admissions_feederschool', ['name'])
    ...
    models = {
        ...
        u'admissions.applicantstandardtestresult': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'sis.cohort': {
            ...
            'students': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['sis.Student']", 'null': 'True', 'through': u"orm['sis.StudentCohort']", 'blank': 'True'})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute("INSERT INTO work_study_clientvisit_supervisor (clientvisit_id, contact_id) select id, supervisor_id  from work_study_clientvisit where supervisor_id is not null;")
        
        # Deleting field 'ClientVisit.supervisor'
        db.delete_column(u'work_study_clientvisit', 'supervisor_id')


    def backwards(self, orm):
        # Adding field 'ClientVisit.supervisor'
        db.add_column(u'work_study_clientvisit', 'supervisor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work_study.Contact'], null=True, blank=True),
                      keep_default=False)

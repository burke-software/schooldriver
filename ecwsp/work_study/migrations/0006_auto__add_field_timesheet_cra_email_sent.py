...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeSheet.cra_email_sent'
        db.add_column(u'work_study_timesheet', 'cra_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeSheet.cra_email_sent'
        db.delete_column(u'work_study_timesheet', 'cra_email_sent')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('work_study', ['CraContact'])

        # Adding model 'PickupLocation'
        db.create_table('work_study_pickuplocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['PickupLocation'])

        # Adding model 'Contact'
        db.create_table('work_study_contact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ...
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('phone_cell', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('fax', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
        ))
        db.send_create_signal('work_study', ['Contact'])

        # Adding model 'Company'
        db.create_table('work_study_company', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('work_study', ['Company'])

        # Adding model 'WorkTeam'
        db.create_table('work_study_workteam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['WorkTeam'])

        # Adding M2M table for field login on 'WorkTeam'
        db.create_table('work_study_workteam_login', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workteam', models.ForeignKey(orm['work_study.workteam'], null=False)),
            #('workteamuser', models.ForeignKey(orm['work_study.workteamuser'], null=False))
            ('workteamuser', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('work_study_workteam_login', ['workteam_id', 'workteamuser_id'])

        # Adding M2M table for field cras on 'WorkTeam'
        db.create_table('work_study_workteam_cras', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workteam', models.ForeignKey(orm['work_study.workteam'], null=False)),
            ('cracontact', models.ForeignKey(orm['work_study.cracontact'], null=False))
        ))
        db.create_unique('work_study_workteam_cras', ['workteam_id', 'cracontact_id'])

        # Adding M2M table for field contacts on 'WorkTeam'
        db.create_table('work_study_workteam_contacts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workteam', models.ForeignKey(orm['work_study.workteam'], null=False)),
            ('contact', models.ForeignKey(orm['work_study.contact'], null=False))
        ))
        db.create_unique('work_study_workteam_contacts', ['workteam_id', 'contact_id'])

        # Adding model 'PaymentOption'
        db.create_table('work_study_paymentoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['PaymentOption'])

        # Adding model 'StudentFunctionalResponsibility'
        db.create_table('work_study_studentfunctionalresponsibility', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('work_study', ['StudentFunctionalResponsibility'])

        # Adding model 'StudentDesiredSkill'
        db.create_table('work_study_studentdesiredskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('work_study', ['StudentDesiredSkill'])

        # Adding model 'CompContract'
        db.create_table('work_study_compcontract', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['CompContract'])

        # Adding M2M table for field student_functional_responsibilities on 'CompContract'
        db.create_table('work_study_compcontract_student_functional_responsibilities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compcontract', models.ForeignKey(orm['work_study.compcontract'], null=False)),
            ('studentfunctionalresponsibility', models.ForeignKey(orm['work_study.studentfunctionalresponsibility'], null=False))
        ))
        db.create_unique('work_study_compcontract_student_functional_responsibilities', ['compcontract_id', 'studentfunctionalresponsibility_id'])

        # Adding M2M table for field student_desired_skills on 'CompContract'
        db.create_table('work_study_compcontract_student_desired_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compcontract', models.ForeignKey(orm['work_study.compcontract'], null=False)),
            ('studentdesiredskill', models.ForeignKey(orm['work_study.studentdesiredskill'], null=False))
        ))
        db.create_unique('work_study_compcontract_student_desired_skills', ['compcontract_id', 'studentdesiredskill_id'])

        # Adding model 'Personality'
        db.create_table('work_study_personality', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('work_study', ['Personality'])

        # Adding model 'Handout33'
        db.create_table('work_study_handout33', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['Handout33'])

        # Adding model 'StudentWorkerRoute'
        db.create_table('work_study_studentworkerroute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('work_study', ['StudentWorkerRoute'])

        # Adding model 'StudentWorker'
        db.create_table('work_study_studentworker', (
            ('student_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sis.Student'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('work_study', ['StudentWorker'])

        # Adding M2M table for field handout33 on 'StudentWorker'
        db.create_table('work_study_studentworker_handout33', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentworker', models.ForeignKey(orm['work_study.studentworker'], null=False)),
            ('handout33', models.ForeignKey(orm['work_study.handout33'], null=False))
        ))
        db.create_unique('work_study_studentworker_handout33', ['studentworker_id', 'handout33_id'])

        # Adding model 'Survey'
        db.create_table('work_study_survey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['Survey'])

        # Adding model 'CompanyHistory'
        db.create_table('work_study_companyhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work_study.StudentWorker'])),
        ...
        db.send_create_signal('work_study', ['CompanyHistory'])

        # Adding unique constraint on 'CompanyHistory', fields ['student', 'placement', 'date']
        db.create_unique('work_study_companyhistory', ['student_id', 'placement_id', 'date'])

        # Adding model 'PresetComment'
        db.create_table('work_study_presetcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('work_study', ['PresetComment'])

        # Adding model 'StudentInteraction'
        db.create_table('work_study_studentinteraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['StudentInteraction'])

        # Adding M2M table for field student on 'StudentInteraction'
        db.create_table('work_study_studentinteraction_student', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentinteraction', models.ForeignKey(orm['work_study.studentinteraction'], null=False)),
            ('studentworker', models.ForeignKey(orm['work_study.studentworker'], null=False))
        ))
        db.create_unique('work_study_studentinteraction_student', ['studentinteraction_id', 'studentworker_id'])

        # Adding M2M table for field preset_comment on 'StudentInteraction'
        db.create_table('work_study_studentinteraction_preset_comment', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentinteraction', models.ForeignKey(orm['work_study.studentinteraction'], null=False)),
            ('presetcomment', models.ForeignKey(orm['work_study.presetcomment'], null=False))
        ))
        db.create_unique('work_study_studentinteraction_preset_comment', ['studentinteraction_id', 'presetcomment_id'])

        # Adding M2M table for field companies on 'StudentInteraction'
        db.create_table('work_study_studentinteraction_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentinteraction', models.ForeignKey(orm['work_study.studentinteraction'], null=False)),
            ('workteam', models.ForeignKey(orm['work_study.workteam'], null=False))
        ))
        db.create_unique('work_study_studentinteraction_companies', ['studentinteraction_id', 'workteam_id'])

        # Adding model 'TimeSheetPerformanceChoice'
        db.create_table('work_study_timesheetperformancechoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=6L, unique=True)),
        ))
        db.send_create_signal('work_study', ['TimeSheetPerformanceChoice'])

        # Adding model 'TimeSheet'
        db.create_table('work_study_timesheet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work_study.StudentWorker'])),
        ...
        db.send_create_signal('work_study', ['TimeSheet'])

        # Adding model 'AttendanceFee'
        db.create_table('work_study_attendancefee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('work_study', ['AttendanceFee'])

        # Adding model 'AttendanceReason'
        db.create_table('work_study_attendancereason', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('work_study', ['AttendanceReason'])

        # Adding model 'Attendance'
        db.create_table('work_study_attendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work_study.StudentWorker'])),
            ('absence_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('tardy', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
        ...
        db.send_create_signal('work_study', ['Attendance'])

        # Adding model 'ClientVisit'
        db.create_table('work_study_clientvisit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('supervisor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work_study.Contact'], null=True, blank=True)),
        ...
        db.send_create_signal('work_study', ['ClientVisit'])

        # Adding model 'MessageToSupervisor'
        db.create_table('work_study_messagetosupervisor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('work_study', ['MessageToSupervisor'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyHistory', fields ['student', 'placement', 'date']
        db.delete_unique('work_study_companyhistory', ['student_id', 'placement_id', 'date'])

        # Deleting model 'CraContact'
        db.delete_table('work_study_cracontact')

        # Deleting model 'PickupLocation'
        db.delete_table('work_study_pickuplocation')

        # Deleting model 'Contact'
        db.delete_table('work_study_contact')

        # Deleting model 'Company'
        db.delete_table('work_study_company')

        # Deleting model 'WorkTeam'
        db.delete_table('work_study_workteam')
        ...
        db.delete_table('work_study_paymentoption')

        # Deleting model 'StudentFunctionalResponsibility'
        db.delete_table('work_study_studentfunctionalresponsibility')

        # Deleting model 'StudentDesiredSkill'
        db.delete_table('work_study_studentdesiredskill')

        # Deleting model 'CompContract'
        db.delete_table('work_study_compcontract')
        ...
        db.delete_table('work_study_personality')

        # Deleting model 'Handout33'
        db.delete_table('work_study_handout33')

        # Deleting model 'StudentWorkerRoute'
        db.delete_table('work_study_studentworkerroute')

        # Deleting model 'StudentWorker'
        db.delete_table('work_study_studentworker')

        # Removing M2M table for field handout33 on 'StudentWorker'
        db.delete_table('work_study_studentworker_handout33')

        # Deleting model 'Survey'
        db.delete_table('work_study_survey')

        # Deleting model 'CompanyHistory'
        db.delete_table('work_study_companyhistory')

        # Deleting model 'PresetComment'
        db.delete_table('work_study_presetcomment')

        # Deleting model 'StudentInteraction'
        db.delete_table('work_study_studentinteraction')
        ...
        db.delete_table('work_study_timesheetperformancechoice')

        # Deleting model 'TimeSheet'
        db.delete_table('work_study_timesheet')

        # Deleting model 'AttendanceFee'
        db.delete_table('work_study_attendancefee')

        # Deleting model 'AttendanceReason'
        db.delete_table('work_study_attendancereason')

        # Deleting model 'Attendance'
        db.delete_table('work_study_attendance')

        # Deleting model 'ClientVisit'
        db.delete_table('work_study_clientvisit')

        # Deleting model 'MessageToSupervisor'
        db.delete_table('work_study_messagetosupervisor')
    ...
    models = {
        ...
        'work_study.contact': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

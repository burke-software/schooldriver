...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.fax'
        db.alter_column('work_study_contact', 'fax', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Contact.phone'
        db.alter_column('work_study_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Contact.phone_cell'
        db.alter_column('work_study_contact', 'phone_cell', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.fax'
        db.alter_column('work_study_contact', 'fax', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'Contact.phone'
        db.alter_column('work_study_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'Contact.phone_cell'
        db.alter_column('work_study_contact', 'phone_cell', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

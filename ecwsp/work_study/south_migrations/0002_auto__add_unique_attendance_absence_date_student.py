...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Attendance', fields ['absence_date', 'student']
        db.delete_unique(u'work_study_attendance', ['absence_date', 'student_id'])
    ...
    models = {
        ...
        u'work_study.attendance': {
            'Meta': {'unique_together': "(('student', 'absence_date'),)", 'object_name': 'Attendance'},

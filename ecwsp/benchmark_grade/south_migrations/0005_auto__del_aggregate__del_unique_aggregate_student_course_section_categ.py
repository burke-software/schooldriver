...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Aggregate', fields ['student', 'course_section', 'category', 'marking_period']
        db.delete_unique(u'benchmark_grade_aggregate', ['student_id', 'course_section_id', 'category_id', 'marking_period_id'])
        ...
        # Adding model 'CourseSectionCategoryMPAggregate'
        db.create_table(u'benchmark_grade_coursesectioncategorympaggregate', (
        ...
        db.send_create_signal(u'benchmark_grade', ['CourseSectionCategoryMPAggregate'])

        # Adding unique constraint on 'CourseSectionCategoryMPAggregate', fields ['student', 'course_section', 'category', 'marking_period']
        db.create_unique(u'benchmark_grade_coursesectioncategorympaggregate', ['student_id', 'course_section_id', 'category_id', 'marking_period_id'])

        # Adding model 'CourseSectionAggregate'
        db.create_table(u'benchmark_grade_coursesectionaggregate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cached_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('cached_substitution', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ...
        db.send_create_signal(u'benchmark_grade', ['CourseSectionAggregate'])

        # Adding unique constraint on 'CourseSectionAggregate', fields ['student', 'course_section']
        db.create_unique(u'benchmark_grade_coursesectionaggregate', ['student_id', 'course_section_id'])

        # Adding model 'CourseSectionMarkingPeriodAggregate'
        db.create_table(u'benchmark_grade_coursesectionmarkingperiodaggregate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cached_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('cached_substitution', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ...
        db.send_create_signal(u'benchmark_grade', ['CourseSectionMarkingPeriodAggregate'])

        # Adding unique constraint on 'CourseSectionMarkingPeriodAggregate', fields ['student', 'course_section', 'marking_period']
        db.create_unique(u'benchmark_grade_coursesectionmarkingperiodaggregate', ['student_id', 'course_section_id', 'marking_period_id'])

        # Adding model 'CategoryMarkingPeriodAggregate'
        db.create_table(u'benchmark_grade_categorymarkingperiodaggregate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cached_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('cached_substitution', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ...
        db.send_create_signal(u'benchmark_grade', ['CategoryMarkingPeriodAggregate'])

        # Adding unique constraint on 'CategoryMarkingPeriodAggregate', fields ['student', 'category', 'marking_period']
        db.create_unique(u'benchmark_grade_categorymarkingperiodaggregate', ['student_id', 'category_id', 'marking_period_id'])

        # Adding model 'CourseSectionCategoryAggregate'
        db.create_table(u'benchmark_grade_coursesectioncategoryaggregate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cached_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('cached_substitution', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ...
        db.send_create_signal(u'benchmark_grade', ['CourseSectionCategoryAggregate'])

        # Adding unique constraint on 'CourseSectionCategoryAggregate', fields ['student', 'course_section', 'category']
        db.create_unique(u'benchmark_grade_coursesectioncategoryaggregate', ['student_id', 'course_section_id', 'category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseSectionCategoryAggregate', fields ['student', 'course_section', 'category']
        db.delete_unique(u'benchmark_grade_coursesectioncategoryaggregate', ['student_id', 'course_section_id', 'category_id'])

        # Removing unique constraint on 'CategoryMarkingPeriodAggregate', fields ['student', 'category', 'marking_period']
        db.delete_unique(u'benchmark_grade_categorymarkingperiodaggregate', ['student_id', 'category_id', 'marking_period_id'])

        # Removing unique constraint on 'CourseSectionMarkingPeriodAggregate', fields ['student', 'course_section', 'marking_period']
        db.delete_unique(u'benchmark_grade_coursesectionmarkingperiodaggregate', ['student_id', 'course_section_id', 'marking_period_id'])

        # Removing unique constraint on 'CourseSectionAggregate', fields ['student', 'course_section']
        db.delete_unique(u'benchmark_grade_coursesectionaggregate', ['student_id', 'course_section_id'])

        # Removing unique constraint on 'CourseSectionCategoryMPAggregate', fields ['student', 'course_section', 'category', 'marking_period']
        db.delete_unique(u'benchmark_grade_coursesectioncategorympaggregate', ['student_id', 'course_section_id', 'category_id', 'marking_period_id'])

        # Adding model 'Aggregate'
        db.create_table(u'benchmark_grade_aggregate', (
            ('course_section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.CourseSection'], null=True, blank=True)),
            ('points_possible', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
        ...
        # Adding unique constraint on 'Aggregate', fields ['student', 'course_section', 'category', 'marking_period']
        db.create_unique(u'benchmark_grade_aggregate', ['student_id', 'course_section_id', 'category_id', 'marking_period_id'])
        ...
        # Deleting model 'CourseSectionCategoryMPAggregate'
        db.delete_table(u'benchmark_grade_coursesectioncategorympaggregate')

        # Deleting model 'CourseSectionAggregate'
        db.delete_table(u'benchmark_grade_coursesectionaggregate')

        # Deleting model 'CourseSectionMarkingPeriodAggregate'
        db.delete_table(u'benchmark_grade_coursesectionmarkingperiodaggregate')

        # Deleting model 'CategoryMarkingPeriodAggregate'
        db.delete_table(u'benchmark_grade_categorymarkingperiodaggregate')

        # Deleting model 'CourseSectionCategoryAggregate'
        db.delete_table(u'benchmark_grade_coursesectioncategoryaggregate')
    ...
    models = {
        ...
        u'benchmark_grade.calculationrulecategoryascourse': {
            ...
            'special_course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseSection']"})
        },
        ...
        u'benchmark_grade.categorymarkingperiodaggregate': {
            'Meta': {'unique_together': "(('student', 'category', 'marking_period'),)", 'object_name': 'CategoryMarkingPeriodAggregate'},
        ...
        u'benchmark_grade.coursesectionaggregate': {
            'Meta': {'unique_together': "(('student', 'course_section'),)", 'object_name': 'CourseSectionAggregate'},
            'cached_substitution': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'cached_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
        ...
        u'benchmark_grade.coursesectioncategoryaggregate': {
            'Meta': {'unique_together': "(('student', 'course_section', 'category'),)", 'object_name': 'CourseSectionCategoryAggregate'},
            'cached_substitution': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'cached_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['benchmark_grade.Category']"}),
            'course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseSection']"}),
        ...
        u'benchmark_grade.coursesectioncategorympaggregate': {
            'Meta': {'unique_together': "(('student', 'course_section', 'category', 'marking_period'),)", 'object_name': 'CourseSectionCategoryMPAggregate'},
            'cached_substitution': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'cached_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['benchmark_grade.Category']"}),
            'course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseSection']"}),
        ...
        u'benchmark_grade.coursesectionmarkingperiodaggregate': {
            'Meta': {'unique_together': "(('student', 'course_section', 'marking_period'),)", 'object_name': 'CourseSectionMarkingPeriodAggregate'},
            'cached_substitution': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'cached_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseSection']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'schedule.course': {
            ...
            'course_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'to': u"orm['schedule.CourseType']"}),

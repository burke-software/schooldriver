...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AggregateTask', fields ['content_type', 'object_id', 'task_id']
        db.create_unique(u'benchmark_grade_aggregatetask', ['content_type_id', 'object_id', 'task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AggregateTask', fields ['content_type', 'object_id', 'task_id']
        db.delete_unique(u'benchmark_grade_aggregatetask', ['content_type_id', 'object_id', 'task_id'])
    ...
    models = {
        ...
        u'benchmark_grade.aggregatetask': {
            'Meta': {'unique_together': "(('content_type', 'object_id', 'task_id'),)", 'object_name': 'AggregateTask'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Category.course'
        db.delete_column('benchmark_grade_category', 'course_id')

        # Deleting field 'Category.weight'
        db.delete_column('benchmark_grade_category', 'weight')

        # Adding field 'Category.display_order'
        db.add_column('benchmark_grade_category', 'display_order',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.display_scale'
        db.add_column('benchmark_grade_category', 'display_scale',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Category.display_symbol'
        db.add_column('benchmark_grade_category', 'display_symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Category.course'
        db.add_column('benchmark_grade_category', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Course'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.weight'
        db.add_column('benchmark_grade_category', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Category.display_order'
        db.delete_column('benchmark_grade_category', 'display_order')

        # Deleting field 'Category.display_scale'
        db.delete_column('benchmark_grade_category', 'display_scale')

        # Deleting field 'Category.display_symbol'
        db.delete_column('benchmark_grade_category', 'display_symbol')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('benchmark_grade_assignmenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('benchmark_grade', ['AssignmentType'])

        # Adding field 'Item.points_possible'
        db.add_column('benchmark_grade_item', 'points_possible',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Item.assignment_type'
        db.add_column('benchmark_grade_item', 'assignment_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.AssignmentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.benchmark'
        db.add_column('benchmark_grade_item', 'benchmark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.Benchmark'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AssignmentType'
        db.delete_table('benchmark_grade_assignmenttype')

        # Deleting field 'Item.points_possible'
        db.delete_column('benchmark_grade_item', 'points_possible')

        # Deleting field 'Item.assignment_type'
        db.delete_column('benchmark_grade_item', 'assignment_type_id')

        # Deleting field 'Item.benchmark'
        db.delete_column('benchmark_grade_item', 'benchmark_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Item.course'
        db.rename_column(u'benchmark_grade_item', 'course_id', 'course_section_id')

        # Renaming field 'Aggregate.course'
        db.rename_column(u'benchmark_grade_aggregate', 'course_id', 'course_section_id')

        # Renaming field 'CalculationRuleCategoryAsCourse.special_course'
        db.rename_column(u'benchmark_grade_calculationrulecategoryascourse', 'special_course_id', 'special_course_section_id')


    def backwards(self, orm):
        # Renaming field 'Item.course_section'
        db.rename_column(u'benchmark_grade_item', 'course_section_id', 'course_id')

        # Renaming field 'Aggregate.course_section'
        db.rename_column(u'benchmark_grade_aggregate', 'course_section_id', 'course_id')

        # Renaming field 'CalculationRuleCategoryAsCourse.special_course_section'
        db.rename_column(u'benchmark_grade_calculationrulecategoryascourse', 'special_course_section_id', 'special_course_id')
    ...
    models = {
        ...
        u'benchmark_grade.aggregate': {
            'Meta': {'unique_together': "(('student', 'course_section', 'category', 'marking_period'),)", 'object_name': 'Aggregate'},
            ...
            'course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseSection']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

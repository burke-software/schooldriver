...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('benchmark_grade_calculationrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_year_effective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sis.SchoolYear'])),
        ))
        db.send_create_signal('benchmark_grade', ['CalculationRule'])

        # Adding model 'CalculationRulePerCourseCategory'
        db.create_table('benchmark_grade_calculationrulepercoursecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('benchmark_grade', ['CalculationRulePerCourseCategory'])

        # Adding M2M table for field apply_to_departments on 'CalculationRulePerCourseCategory'
        db.create_table('benchmark_grade_calculationrulepercoursecategory_apply_to_dec2df', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calculationrulepercoursecategory', models.ForeignKey(orm['benchmark_grade.calculationrulepercoursecategory'], null=False)),
            ('department', models.ForeignKey(orm['schedule.department'], null=False))
        ))
        db.create_unique('benchmark_grade_calculationrulepercoursecategory_apply_to_dec2df', ['calculationrulepercoursecategory_id', 'department_id'])

        # Adding model 'CalculationRuleCategoryAsCourse'
        db.create_table('benchmark_grade_calculationrulecategoryascourse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Category'])),
        ...
        db.send_create_signal('benchmark_grade', ['CalculationRuleCategoryAsCourse'])

        # Adding M2M table for field include_departments on 'CalculationRuleCategoryAsCourse'
        db.create_table('benchmark_grade_calculationrulecategoryascourse_include_depabed5', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calculationrulecategoryascourse', models.ForeignKey(orm['benchmark_grade.calculationrulecategoryascourse'], null=False)),
            ('department', models.ForeignKey(orm['schedule.department'], null=False))
        ))
        db.create_unique('benchmark_grade_calculationrulecategoryascourse_include_depabed5', ['calculationrulecategoryascourse_id', 'department_id'])


    def backwards(self, orm):
        # Deleting model 'CalculationRule'
        db.delete_table('benchmark_grade_calculationrule')

        # Deleting model 'CalculationRulePerCourseCategory'
        db.delete_table('benchmark_grade_calculationrulepercoursecategory')
        ...
        db.delete_table('benchmark_grade_calculationrulecategoryascourse')

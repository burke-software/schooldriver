...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Aggregate', fields ['category', 'course', 'marking_period', 'student']
        db.create_unique(u'benchmark_grade_aggregate', ['category_id', 'course_id', 'marking_period_id', 'student_id'])

        # Deleting field 'Mark.description'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Mark.description'
        db.add_column(u'benchmark_grade_mark', 'description',
    ...
    models = {
        ...
        u'benchmark_grade.mark': {
            'Meta': {'unique_together': "(('item', 'student'),)", 'object_name': 'Mark'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aggregate.scale'
        db.alter_column('benchmark_grade_aggregate', 'scale_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Scale'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Aggregate.scale'
        raise RuntimeError("Cannot reverse this migration. 'Aggregate.scale' and its values cannot be restored.")
    ...
    models = {
        ...
        'benchmark_grade.aggregate': {
            ...
            'scale': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['benchmark_grade.Scale']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aggregate.points_possible'
        db.add_column('benchmark_grade_aggregate', 'points_possible',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aggregate.points_possible'
        db.delete_column('benchmark_grade_aggregate', 'points_possible')

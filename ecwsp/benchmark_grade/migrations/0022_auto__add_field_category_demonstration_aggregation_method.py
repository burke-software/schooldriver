...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.demonstration_aggregation_method'
        db.add_column(u'benchmark_grade_category', 'demonstration_aggregation_method',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.demonstration_aggregation_method'
        db.delete_column(u'benchmark_grade_category', 'demonstration_aggregation_method')

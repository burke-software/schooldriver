...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('benchmark_grade_demonstration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Item'])),
        ))
        db.send_create_signal('benchmark_grade', ['Demonstration'])

        # Adding field 'Item.description'
        db.add_column('benchmark_grade_item', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.allow_multiple_demonstrations'
        db.add_column('benchmark_grade_category', 'allow_multiple_demonstrations',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Category.fixed_points_possible'
        db.add_column('benchmark_grade_category', 'fixed_points_possible',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Category.fixed_granularity'
        db.add_column('benchmark_grade_category', 'fixed_granularity',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Mark.demonstration'
        db.add_column('benchmark_grade_mark', 'demonstration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Demonstration'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Demonstration'
        db.delete_table('benchmark_grade_demonstration')

        # Deleting field 'Item.description'
        db.delete_column('benchmark_grade_item', 'description')

        # Deleting field 'Category.allow_multiple_demonstrations'
        db.delete_column('benchmark_grade_category', 'allow_multiple_demonstrations')

        # Deleting field 'Category.fixed_points_possible'
        db.delete_column('benchmark_grade_category', 'fixed_points_possible')

        # Deleting field 'Category.fixed_granularity'
        db.delete_column('benchmark_grade_category', 'fixed_granularity')

        # Deleting field 'Mark.demonstration'
        db.delete_column('benchmark_grade_mark', 'demonstration_id')

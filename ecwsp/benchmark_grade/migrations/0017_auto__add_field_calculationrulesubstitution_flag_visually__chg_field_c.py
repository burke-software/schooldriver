...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalculationRuleSubstitution.flag_visually'
        db.add_column(u'benchmark_grade_calculationrulesubstitution', 'flag_visually',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CalculationRuleSubstitution.display_as'
        db.alter_column(u'benchmark_grade_calculationrulesubstitution', 'display_as', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

    def backwards(self, orm):
        # Deleting field 'CalculationRuleSubstitution.flag_visually'
        db.delete_column(u'benchmark_grade_calculationrulesubstitution', 'flag_visually')


        # Changing field 'CalculationRuleSubstitution.display_as'
        db.alter_column(u'benchmark_grade_calculationrulesubstitution', 'display_as', self.gf('django.db.models.fields.CharField')(default=None, max_length=16))
    ...
    models = {
        ...
        u'benchmark_grade.calculationrule': {
            ...
            'first_year_effective': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sis.SchoolYear']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

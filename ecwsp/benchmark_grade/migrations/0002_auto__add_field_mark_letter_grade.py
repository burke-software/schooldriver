...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mark.letter_grade'
        db.add_column(u'benchmark_grade_mark', 'letter_grade',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mark.letter_grade'
        db.delete_column(u'benchmark_grade_mark', 'letter_grade')

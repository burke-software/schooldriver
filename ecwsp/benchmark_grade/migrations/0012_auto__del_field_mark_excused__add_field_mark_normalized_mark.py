...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mark.excused'
        db.delete_column('benchmark_grade_mark', 'excused')

        # Adding field 'Mark.normalized_mark'
        db.add_column('benchmark_grade_mark', 'normalized_mark',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Mark.excused'
        db.add_column('benchmark_grade_mark', 'excused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Mark.normalized_mark'
        db.delete_column('benchmark_grade_mark', 'normalized_mark')

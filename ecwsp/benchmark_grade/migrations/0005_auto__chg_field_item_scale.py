...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.scale'
        db.alter_column('benchmark_grade_item', 'scale_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Scale'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Item.scale'
        raise RuntimeError("Cannot reverse this migration. 'Item.scale' and its values cannot be restored.")

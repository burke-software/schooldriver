...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.benchmark'
        db.alter_column('benchmark_grade_item', 'benchmark_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['omr.Benchmark'], null=True))

        # Changing field 'Mark.normalized_mark'
        db.alter_column('benchmark_grade_mark', 'normalized_mark', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=7))
    ...
    models = {
        ...
        'benchmark_grade.item': {
            ...
            'benchmark': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['benchmarks.Benchmark']", 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['benchmark_grade.Category']"}),

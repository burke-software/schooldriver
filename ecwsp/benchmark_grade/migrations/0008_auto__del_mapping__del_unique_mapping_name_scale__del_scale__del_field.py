...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.scale'
        db.delete_column('benchmark_grade_item', 'scale_id')

        # Deleting field 'Aggregate.scale'
        db.delete_column('benchmark_grade_aggregate', 'scale_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Item.scale'
        db.add_column('benchmark_grade_item', 'scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Scale'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Aggregate.scale'
        db.add_column('benchmark_grade_aggregate', 'scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['benchmark_grade.Scale'], null=True, blank=True),
                      keep_default=False)

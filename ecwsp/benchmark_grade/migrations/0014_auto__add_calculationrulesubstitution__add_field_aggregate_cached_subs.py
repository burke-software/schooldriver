...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('benchmark_grade_calculationrulesubstitution', (
            ...
            ('display_as', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ...
        db.send_create_signal('benchmark_grade', ['CalculationRuleSubstitution'])

        # Adding M2M table for field apply_to_departments on 'CalculationRuleSubstitution'
        db.create_table('benchmark_grade_calculationrulesubstitution_apply_to_departments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calculationrulesubstitution', models.ForeignKey(orm['benchmark_grade.calculationrulesubstitution'], null=False)),
            ('department', models.ForeignKey(orm['schedule.department'], null=False))
        ))
        db.create_unique('benchmark_grade_calculationrulesubstitution_apply_to_departments', ['calculationrulesubstitution_id', 'department_id'])

        # Adding M2M table for field apply_to_categories on 'CalculationRuleSubstitution'
        db.create_table('benchmark_grade_calculationrulesubstitution_apply_to_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calculationrulesubstitution', models.ForeignKey(orm['benchmark_grade.calculationrulesubstitution'], null=False)),
            ('category', models.ForeignKey(orm['benchmark_grade.category'], null=False))
        ))
        db.create_unique('benchmark_grade_calculationrulesubstitution_apply_to_categories', ['calculationrulesubstitution_id', 'category_id'])

        # Adding field 'Aggregate.cached_substitution'
        db.add_column('benchmark_grade_aggregate', 'cached_substitution',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('benchmark_grade_calculationrulesubstitution')
        ...
        # Deleting field 'Aggregate.cached_substitution'
        db.delete_column('benchmark_grade_aggregate', 'cached_substitution')
    ...
    models = {
        ...
        'benchmark_grade.calculationrulesubstitution': {
            'Meta': {'object_name': 'CalculationRuleSubstitution'},
            'apply_to_categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['benchmark_grade.Category']", 'null': 'True', 'blank': 'True'}),
            'apply_to_departments': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['schedule.Department']", 'null': 'True', 'blank': 'True'}),
            'calculate_as': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'calculation_rule': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'substitution_set'", 'to': "orm['benchmark_grade.CalculationRule']"}),
            'display_as': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'benchmark_grade.mark': {
            ...
            'demonstration': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['benchmark_grade.Demonstration']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['benchmark_grade.Item']"}),
            'mark': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'normalized_mark': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '7', 'blank': 'True'}),

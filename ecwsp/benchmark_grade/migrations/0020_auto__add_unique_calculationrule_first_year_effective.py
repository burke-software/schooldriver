...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CalculationRule', fields ['first_year_effective']
        db.create_unique(u'benchmark_grade_calculationrule', ['first_year_effective_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CalculationRule', fields ['first_year_effective']
        db.delete_unique(u'benchmark_grade_calculationrule', ['first_year_effective_id'])

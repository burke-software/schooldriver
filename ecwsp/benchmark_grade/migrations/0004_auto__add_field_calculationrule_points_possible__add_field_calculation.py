...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalculationRule.points_possible'
        db.add_column('benchmark_grade_calculationrule', 'points_possible',
                      self.gf('django.db.models.fields.DecimalField')(default=4, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'CalculationRule.decimal_places'
        db.add_column('benchmark_grade_calculationrule', 'decimal_places',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalculationRule.points_possible'
        db.delete_column('benchmark_grade_calculationrule', 'points_possible')

        # Deleting field 'CalculationRule.decimal_places'
        db.delete_column('benchmark_grade_calculationrule', 'decimal_places')

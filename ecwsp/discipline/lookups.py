...
class StudentWithDisciplineLookup(StudentLookup):
    def format_item(self,student):
        ...
        output = "<table style=\"border-collapse: collapse; width:700px;\"><tr><td><img src=%s></td><td>%s %s <br/><a href=\"/discipline/disc/report/%s\">View full report</a>" \
...
class DisciplineViewStudentLookup(StudentLookup):
    def format_item_display(self,student):
        ...
        output = "<table style=\"border-collapse: collapse;\"><tr><td><img src=%s></td><td>%s %s <br/><a href=\"/discipline/disc/report/%s\">View full report</a></td></tr></table>" \
            % (image, student.fname, student.lname, student.id) 
        if priors.count() >= 1:

...
def get_start_date_default():
    ...
    days_back = int(config.DISCIPLINE_MERIT_DEFAULT_DAYS)
    ...
    return default_date
def get_default_one():
    return int(config.DISCIPLINE_MERIT_LEVEL_ONE)
def get_default_two():
    return int(config.DISCIPLINE_MERIT_LEVEL_TWO)
def get_default_three():
    return int(config.DISCIPLINE_MERIT_LEVEL_THREE)
def get_default_four():
    return int(config.DISCIPLINE_MERIT_LEVEL_FOUR)

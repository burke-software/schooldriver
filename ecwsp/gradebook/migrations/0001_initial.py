...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('sis', '0006_merge'),
        ('schedule', '0006_auto_20150531_1037'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_year_effective', models.OneToOneField(related_name='gradebook_calculationrule_set', to='sis.SchoolYear', help_text=b'Rule also applies to subsequent years.')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('weight', ecwsp.gradebook.models.WeightField(default=1, max_digits=5, decimal_places=4)),
                ('apply_to_departments', models.ManyToManyField(related_name='gradebook_calculationrulepercoursecategory_set', to='schedule.Department', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apply_to_categories', models.ManyToManyField(to='gradebook.AssignmentCategory', blank=True)),
                ('apply_to_departments', models.ManyToManyField(related_name='+', to='schedule.Department', blank=True)),

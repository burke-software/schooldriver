...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEnrollment.exclude_days'
        db.add_column(u'schedule_courseenrollment', 'exclude_days',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CourseEnrollment.exclude_days'
        db.delete_column(u'schedule_courseenrollment', 'exclude_days')

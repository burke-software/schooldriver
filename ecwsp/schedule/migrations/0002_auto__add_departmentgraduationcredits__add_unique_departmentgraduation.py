...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schedule_departmentgraduationcredits', (
        ...
        db.send_create_signal('schedule', ['DepartmentGraduationCredits'])

        # Adding unique constraint on 'DepartmentGraduationCredits', fields ['department', 'class_year']
        db.create_unique('schedule_departmentgraduationcredits', ['department_id', 'class_year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DepartmentGraduationCredits', fields ['department', 'class_year']
        db.delete_unique('schedule_departmentgraduationcredits', ['department_id', 'class_year_id'])

        # Deleting model 'DepartmentGraduationCredits'
        db.delete_table('schedule_departmentgraduationcredits')
    ...
    models = {
        ...
        'schedule.departmentgraduationcredits': {
            'Meta': {'unique_together': "(('department', 'class_year'),)", 'object_name': 'DepartmentGraduationCredits'},
            'class_year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sis.ClassYear']"}),
            'credits': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Department']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'schedule.location': {
        ...
        'schedule.standardtestresult': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_on_reports': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sis.Student']"}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.StandardTest']"})

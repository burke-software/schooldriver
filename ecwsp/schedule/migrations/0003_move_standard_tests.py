...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.rename_table('schedule_standardcategory', 'standard_test_standardcategory')
        db.rename_table('schedule_standardcategorygrade', 'standard_test_standardcategorygrade')
        db.rename_table('schedule_standardtest', 'standard_test_standardtest')
        db.rename_table('schedule_standardtestresult', 'standard_test_standardtestresult') 

        if not db.dry_run:
            try:
                orm['contenttypes.contenttype'].objects.filter(app_label='schedule', model='standardcategory').update(app_label='standard_test')
                orm['contenttypes.contenttype'].objects.filter(app_label='schedule', model='standardcategorygrade').update(app_label='standard_test')
                orm['contenttypes.contenttype'].objects.filter(app_label='schedule', model='standardtest').update(app_label='standard_test')
                orm['contenttypes.contenttype'].objects.filter(app_label='schedule', model='standardtestresult').update(app_label='standard_test')
            except:
                print "WARNING: Could not migrate standard_test content types"

    def backwards(self, orm):
        db.rename_table('standard_test_standardcategory', 'schedule_standardcategory')
        db.rename_table('standard_test_standardcategorygrade', 'schedule_standardcategorygrade')
        db.rename_table('standard_test_standardtest', 'schedule_standardtest')
        db.rename_table('standard_test_standardtestresult', 'schedule_standardtestresult') 
    ...
    models = {
        ...
        u'standard_test.standardcategorygrade': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['standard_test.StandardTestResult']"})
        },
    ...
    complete_apps = ['standard_test', 'schedule']
    symmetrical = True

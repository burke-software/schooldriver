...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schedule_coursesection', (
            ...
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections', to=orm['schedule.Course'])),
        ...
        m2m_table_name = db.shorten_name(u'schedule_coursesection_marking_period')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coursesection', models.ForeignKey(orm[u'schedule.coursesection'], null=False)),
            ('markingperiod', models.ForeignKey(orm[u'schedule.markingperiod'], null=False))
        ))
        db.create_unique(m2m_table_name, ['coursesection_id', 'markingperiod_id'])
        ...
        db.create_table(u'schedule_coursesectionteacher', (
            ...
            ('course_section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.CourseSection'], null=True)),
        ...
        db.create_unique(u'schedule_coursesectionteacher', ['teacher_id', 'course_section_id'])

        # Adding field 'CourseMeet.course_section'
        db.add_column(u'schedule_coursemeet', 'course_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.CourseSection'], null=True),
                      keep_default=False)

        # Adding field 'Course.is_active'
        db.add_column(u'schedule_course', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CourseEnrollment.course_section'
        db.add_column(u'schedule_courseenrollment', 'course_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.CourseSection'], null=True),
                      keep_default=False)

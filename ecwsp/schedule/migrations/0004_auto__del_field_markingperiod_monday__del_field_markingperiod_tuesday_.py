...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkingPeriod.grades_due'
        db.add_column(u'schedule_markingperiod', 'grades_due',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkingPeriod.grades_due'
        db.delete_column(u'schedule_markingperiod', 'grades_due')

        ...
        for course in courses:
            ...
            for secondary_teacher in course.secondary_teachers.all():
                ...
                if created:
                    ...
                    print '{} ({}) / {} ({}) appears to be both a primary and secondary \
teacher for course {} ({})!'.format(secondary_teacher.username, secondary_teacher.pk,
                        course.teacher.username, course.teacher.pk, course.fullname,
                        course.pk)

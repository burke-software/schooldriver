...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Grade.course'
        db.rename_column(u'grades_grade', 'course_id', 'course_section_id')

        # Removing unique constraint on 'GradeLetterRule', fields ['min_grade', 'max_grade']
        db.delete_unique(u'grades_gradeletterrule', ['min_grade', 'max_grade'])

        # Deleting model 'GradeLetterRule'
        db.delete_table(u'grades_gradeletterrule')

        # Adding model 'GradeScale'
        db.create_table(u'grades_gradescale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'grades', ['GradeScale'])

        # Adding model 'GradeScaleRule'
        db.create_table(u'grades_gradescalerule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('max_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('letter_grade', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('numeric_scale', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('grade_scale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grades.GradeScale'])),
        ))
        db.send_create_signal(u'grades', ['GradeScaleRule'])

        # Adding unique constraint on 'GradeScaleRule', fields ['min_grade', 'max_grade', 'grade_scale']
        db.create_unique(u'grades_gradescalerule', ['min_grade', 'max_grade', 'grade_scale_id'])


    def backwards(self, orm):
        # Renaming field 'Grade.course_section'
        db.rename_column(u'grades_grade', 'course_section_id', 'course_id')

        # Removing unique constraint on 'GradeScaleRule', fields ['min_grade', 'max_grade', 'grade_scale']
        db.delete_unique(u'grades_gradescalerule', ['min_grade', 'max_grade', 'grade_scale_id'])

        # Adding model 'GradeLetterRule'
        db.create_table(u'grades_gradeletterrule', (
            ('letter_grade', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
            ('min_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('max_grade', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'grades', ['GradeLetterRule'])

        # Adding unique constraint on 'GradeLetterRule', fields ['min_grade', 'max_grade']
        db.create_unique(u'grades_gradeletterrule', ['min_grade', 'max_grade'])

        # Deleting model 'GradeScale'
        db.delete_table(u'grades_gradescale')

        # Deleting model 'GradeScaleRule'
        db.delete_table(u'grades_gradescalerule')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grade.enrollment'
        db.add_column(u'grades_grade', 'enrollment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.CourseEnrollment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grade.enrollment'
        db.delete_column(u'grades_grade', 'enrollment_id')
    ...
    models = {
        ...
        u'grades.grade': {
            ...
            'enrollment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.CourseEnrollment']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'grades_gradecomment', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'grades', ['GradeComment'])

        # Adding model 'Grade'
        db.create_table(u'grades_grade', (
        ...
        db.send_create_signal(u'grades', ['Grade'])

        # Adding unique constraint on 'Grade', fields ['student', 'course', 'marking_period']
        db.create_unique(u'grades_grade', ['student_id', 'course_id', 'marking_period_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Grade', fields ['student', 'course', 'marking_period']
        db.delete_unique(u'grades_grade', ['student_id', 'course_id', 'marking_period_id'])

        # Deleting model 'GradeComment'
        db.delete_table(u'grades_gradecomment')

        # Deleting model 'Grade'
        db.delete_table(u'grades_grade')

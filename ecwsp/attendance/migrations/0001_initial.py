...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'attendance_attendancestatus', (
            ...
            ('half', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'attendance', ['AttendanceStatus'])

        # Adding model 'CourseAttendance'
        ...
        db.send_create_signal(u'attendance', ['CourseAttendance'])
        ...
        db.create_unique(u'attendance_studentattendance', ['student_id', 'date', 'status_id'])

        # Adding model 'AttendanceLog'
        db.create_table(u'attendance_attendancelog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'attendance_studentattendance', ['student_id', 'date', 'status_id'])

        # Deleting model 'AttendanceStatus'
        db.delete_table(u'attendance_attendancestatus')

        # Deleting model 'CourseAttendance'
        db.delete_table(u'attendance_courseattendance')

        # Deleting model 'StudentAttendance'
        db.delete_table(u'attendance_studentattendance')

        # Deleting model 'AttendanceLog'
        db.delete_table(u'attendance_attendancelog')
    ...
    models = {
        ...
        u'attendance.courseattendance': {
            ...
            'period': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['schedule.Period']", 'null': 'True', 'blank': 'True'}),

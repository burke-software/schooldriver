...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AttendanceStatus'
        db.create_table('attendance_attendancestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('teacher_selectable', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('tardy', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('attendance', ['AttendanceStatus'])

        # Adding model 'StudentAttendance'
        db.create_table('attendance_studentattendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_attn', to=orm['sis.Student'])),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attendance.AttendanceStatus'])),
            ...
            ('private_notes', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
        ))
        db.send_create_signal('attendance', ['StudentAttendance'])

        # Adding unique constraint on 'StudentAttendance', fields ['student', 'date', 'status']
        db.create_unique('attendance_studentattendance', ['student_id', 'date', 'status_id'])

        # Adding model 'AttendanceLog'
        db.create_table('attendance_attendancelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('attendance', ['AttendanceLog'])

        # Adding model 'AttendanceDailyStat'
        db.create_table('attendance_attendancedailystat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('present', self.gf('django.db.models.fields.IntegerField')()),
            ('absent', self.gf('django.db.models.fields.IntegerField')()),
            ('tardy', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('attendance', ['AttendanceDailyStat'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudentAttendance', fields ['student', 'date', 'status']
        db.delete_unique('attendance_studentattendance', ['student_id', 'date', 'status_id'])

        # Deleting model 'AttendanceStatus'
        db.delete_table('attendance_attendancestatus')

        # Deleting model 'StudentAttendance'
        db.delete_table('attendance_studentattendance')

        # Deleting model 'AttendanceLog'
        db.delete_table('attendance_attendancelog')

        # Deleting model 'AttendanceDailyStat'
        db.delete_table('attendance_attendancedailystat')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'attendance_attendancedailystat')


    def backwards(self, orm):
        # Adding model 'AttendanceDailyStat'
        db.create_table(u'attendance_attendancedailystat', (
        ...
        db.send_create_signal(u'attendance', ['AttendanceDailyStat'])

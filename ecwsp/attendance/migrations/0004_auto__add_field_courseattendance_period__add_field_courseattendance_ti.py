...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseAttendance.period'
        db.add_column(u'attendance_courseattendance', 'period',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Period'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseAttendance.time_in'
        db.add_column(u'attendance_courseattendance', 'time_in',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseAttendance.period'
        db.delete_column(u'attendance_courseattendance', 'period_id')

        # Deleting field 'CourseAttendance.time_in'
        db.delete_column(u'attendance_courseattendance', 'time_in')


    models = {
        u'attendance.attendancedailystat': {

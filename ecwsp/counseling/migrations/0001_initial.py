...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'counseling_studentmeeting_students', (
        ...
        db.create_unique(u'counseling_studentmeeting_students', ['studentmeeting_id', 'student_id'])
        ...
        db.create_table(u'counseling_referralform_referral_reasons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(u'counseling_referralform_referral_reasons', ['referralform_id', 'referralreason_id'])
